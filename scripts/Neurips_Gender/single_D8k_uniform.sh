...
OUTPUT_DIR="./results_neurips/Gender/D_8K_uniform_single" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} --main_process_port 29655 src/kd_train_text_to_image_gender_baseline.py \
