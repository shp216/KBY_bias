...
OUTPUT_DIR="./results_T1_0424/Gender/G_24K_T1000" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=2,3 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} src/kd_train_text_to_image_gender.py \
