...
#TRAIN_DATA_DIR="./data/Gender_latent_20k" # 절대 경로로 설정]
TRAIN_DATA_DIR="./data/LAION_latent_212k" # 절대 경로로 설정]
EXTRA_TEXT_DIR=None
...
OUTPUT_DIR="./results_T1_0424/Gender/laion_gender_fixed_256" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=2,3 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} --main_process_port 29655 src/kd_train_text_to_image_gender.py \
