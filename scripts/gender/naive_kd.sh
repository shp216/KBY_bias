...
OUTPUT_DIR="./results_gender/naive_kd" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} src/debias_gender.py \
