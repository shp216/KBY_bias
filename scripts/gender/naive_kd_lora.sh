...
OUTPUT_DIR="./results_gender/naive_kd_lora" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=2,3 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} --main_process_port 29673 src/debias_gender_lora.py \
