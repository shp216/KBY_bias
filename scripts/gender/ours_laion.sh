...
OUTPUT_DIR="./results_gender/ours_laion" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} src/debias_gender_lora.py \
