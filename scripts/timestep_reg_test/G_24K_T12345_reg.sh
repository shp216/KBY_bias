...
OUTPUT_DIR="./results_timestep_reg_test3/Gender/G_24K_T12345_reg_1e-2" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=1 accelerate launch --num_processes ${NUM_GPUS} src/kd_train_gender_multitmp.py \
