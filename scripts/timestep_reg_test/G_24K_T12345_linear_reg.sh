...
OUTPUT_DIR="./results_timestep_reg_test3/Gender/G_24K_T12345_linear_reg" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=3 accelerate launch --num_processes ${NUM_GPUS} src/kd_train_gender_multitmp.py \
