...
OUTPUT_DIR="./results_T1_0424/Gender/G_24k_img_laion_text_occup_linear" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} src/kd_train_text_to_image_gender.py \
