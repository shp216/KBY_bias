...
OUTPUT_DIR="./results_T1_0424/Gender/G_24K_no_rc_linear" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=2,3 accelerate launch --multi_gpu --num_processes ${NUM_GPUS} --main_process_port 29673 src/kd_train_text_to_image_gender.py \
