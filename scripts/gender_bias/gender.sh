...
TRAIN_DATA_DIR="./data/x0_occupation_gender_latent" # 절대 경로로 설정]
EXTRA_TEXT_DIR=None
...
OUTPUT_DIR="./results/G_256_basic" # please adjust it if needed
...
CUDA_VISIBLE_DEVICES=0 accelerate launch --num_processes ${NUM_GPUS} src/kd_train_text_to_image_gender.py \
