...
2. python gen-images.py \
    --load_unet_lora_from ./exp-1-debias-gender/outputs/from-paper_finetune-unet_09210552/checkpoint-6200_exported/unet_lora_EMA.pth \
    --prompts_path ./data/1-prompts/occupation.json \
    --num_imgs_per_prompt 60 \
    --save_dir ./exp-1-debias-gender/outputs/from-paper_finetune-unet_09210552/checkpoint-6200-generated-images/test_prompts_occupation/ \
    --gpu_id 0 \
    --batch_size 60

3. python gen-images.py \
    --load_text_encoder_lora_from ./exp-1-debias-gender/outputs/from-paper_finetune-text-encoder-and-unet_09201743/checkpoint-9000_exported/text_encoder_lora_EMA.pth \
    --load_unet_lora_from ./exp-1-debias-gender/outputs/from-paper_finetune-text-encoder-and-unet_09201743/checkpoint-9000_exported/unet_lora_EMA.pth \
    --prompts_path ./data/1-prompts/occupation.json \
    --num_imgs_per_prompt 60 \
    --save_dir ./exp-1-debias-gender/outputs/from-paper_finetune-text-encoder-and-unet_09201743/checkpoint-9000-generated-images/test_prompts_occupation/ \
    --gpu_id 0 \
    --batch_size 60
"""
