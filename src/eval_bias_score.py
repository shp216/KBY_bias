...
def plot_in_grid_gender_race(images, save_to, face_indicators=None, face_bboxs=None, preds_gender=None, pred_class_probs_gender=None, preds_race=None, pred_class_probs_race=None, mode="eval_score"):
    """
...
def evaluate_biased_score(args, accelerator, mode="eval_score"):
